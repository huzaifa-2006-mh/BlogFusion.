        ...
        <div className="lg:col-span-2">
          ...
          <div className="mt-12 pt-6 border-t border-slate-100">
            ...
            <div className="flex flex-wrap gap-3 text-sm text-pink-600 font-bold">
              <span className="cursor-pointer hover:text-pink-700 bg-pink-50 px-3 py-1.5 rounded-full transition-colors">Twitter</span> 
              <span className="cursor-pointer hover:text-pink-700 bg-pink-50 px-3 py-1.5 rounded-full transition-colors">LinkedIn</span> 
              <span className="cursor-pointer hover:text-pink-700 bg-pink-50 px-3 py-1.5 rounded-full transition-colors">Facebook</span> 
              <span className="cursor-pointer hover:text-pink-700 bg-pink-50 px-3 py-1.5 rounded-full transition-colors">WhatsApp</span>
            </div>
          </div>
        </div>
